<?php
    ...
    if ($conn) {
        ...
        $fetch = mysql_query("SELECT * FROM inventory WHERE inventory_id LIKE '%$param%' OR SN LIKE '%$param%' OR building LIKE '%$param%' OR room LIKE '%$param%' OR common_name LIKE '%$param%' OR hw_type LIKE '%$param%' OR purchase_date LIKE '%$param%' OR warranty_expire LIKE '%$param%' ");
