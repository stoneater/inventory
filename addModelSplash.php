...
<div data-role="page" class="type-interior mybg">
	<div data-role="header" data-theme="a">
		<h1>Add Inventory Model</h1>
		<a href="#" data-icon="home" data-iconpos="notext" data-direction="reverse" onclick="history.go(-1)">Home</a>
	</div><!-- /header -->	
<br />
<div data-role="content">
<label for="basic"><b>Select the model type.</b></label>
<br />
	<form name="status" method="post" action="addModel.php">
		<label for="basic">Hardware Type:</label>
			<select name="hw_type">
				<option selected value="<?php print "addModelSplash.php"?>">--- ----</option>
		...
		<input type="submit" name="Submit" value="Submit" class="button" title="Submit type" data-inline="true" data-theme="d">	
	</form>
<?php
} else {
?>
